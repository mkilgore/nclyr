...
struct manager_win manager_win = {
    .super_win = {
        ...
        .keypresses = (const struct nclyr_keypress[]) {
            NCLYR_KEYPRESS('j', handle_ch, "Select Window below"),
            NCLYR_KEYPRESS(KEY_DOWN, handle_ch, "Select Window below"),
            NCLYR_KEYPRESS('k', handle_ch, "Select Window above"),
            NCLYR_KEYPRESS(KEY_UP, handle_ch, "Select Window above"),
            NCLYR_KEYPRESS('1', handle_window_select, "Select Window 1"),
            NCLYR_KEYPRESS('2', handle_window_select, "Select Window 2"),
            NCLYR_KEYPRESS('3', handle_window_select, "Select Window 3"),
            NCLYR_KEYPRESS('4', handle_window_select, "Select Window 4"),
            NCLYR_KEYPRESS('5', handle_window_select, "Select Window 5"),
            NCLYR_KEYPRESS('6', handle_window_select, "Select Window 6"),
            NCLYR_KEYPRESS('7', handle_window_select, "Select Window 7"),
            NCLYR_KEYPRESS('8', handle_window_select, "Select Window 8"),
            NCLYR_KEYPRESS('9', handle_window_select, "Select Window 9"),
